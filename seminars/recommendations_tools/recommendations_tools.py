...
def similar_films(critics_dict, person1, person2):
    """Return a list of intersection of films"""
    sim_film = []
...
def sim_distance(critics_dict, person1, person2):
    """Return similarity of two critics based on Euclidean distance"""
...
def sim_pearson(critics_dict, person1, person2):
    """Return similarity of two critics based on Pearson correlation"""
    sim_films = similar_films(critics_dict, person1, person2)
...
def transform_prefs(critics_dict):
    """Transform dics of person: [film1: rating1, film2: rating2, ...] 
    to dict of film: [person1: rating1, person2: rating2, ..]"""
    result = {}
